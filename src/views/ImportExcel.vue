...
export default {
  ...
  methods: {
    ...
    buldHardware(obj,length){
        this.bulk.hardware=[]
        let a=[{l:'A',v:'type'},{l:'B',v:'name'},{l:'C',v:'sn'},{l:'D',v:'supervisor'},{l:'E',v:'code'},{l:'F',v:'zone'},{l:'G',v:'brand'},{l:'H',v:'model'},{l:'I',v:'units'},{l:'J',v:'installedOn'},{l:'K',v:'purchasedOn'},{l:'L',v:'warranty'},{l:'M',v:'ips'},{l:'N',v:'components'},{l:'O',v:'attributes'}]
          ...
          try{
            a.forEach((item,index)=>{
              if(obj[item.l+i]){
                ...
                if(index===0){
                  throw new Error(`${this.$t('check')}${i}${this.$t('row')}${this.$t('type')},${this.$t('type')}${this.$t('required')}`);
                }else if(index===1){
                  throw new Error(`${this.$t('check')}${i}${this.$t('row')}${this.$t('name')},${this.$t('name')}${this.$t('required')}`);
                }else if(index===2){
                  throw new Error(`${this.$t('check')}${i}${this.$t('row')}SN,SN ${this.$t('required')}`);
                }else if(index===4){
                  throw new Error(`${this.$t('check')}${i}${this.$t('row')}${this.$t('code')},${this.$t('code')}${this.$t('required')}`);
                }else if(index===5){
                  throw new Error(`${this.$t('check')}${i}${this.$t('row')}${this.$t('zone')},${this.$t('zone')}${this.$t('required')}`);
                }
              }
            })
          }catch(err){
